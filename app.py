...
import csv
# from langchain.utils import tiktoken
...
# Get the tokenizer for the T5-base model
    # tokenizer = tiktoken.get_encoding('t5-base')

# Use the TokenTextSplitter with the T5-base model and specified tokenizer
